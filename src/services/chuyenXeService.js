...
const danhSachChuyenXeService = async () => {
  try{
    return await ChuyenXe.find();
  }catch(error)
  {
...
module.exports = {danhSachChuyenXeService, createChuyenXeService, getChuyenXeById, updateChuyenXeService};